...
function ClassesPanel() {
  ...
  const handleAccessClass = (classroom) => {
      ...
      <div className="flex gap-20">
        <div className="flex flex-col p-4 items-center gap-2">
          ...
          <select
            ...
            className="rounded-sm border border-[#e1dcdc] p-2"
        ...
        <div className="flex flex-col items-center justify-center gap-2">
          ...
          >
            ...
            <option value="EDUCACAO_JOVENS_ADULTOS">
        ...
        <div className="p-4">
          ...
          <div>
            {classroomsFiltered?.map((c) => (
              <div key={c.id} className="p-2 flex justify-between border border-[#e1dcdc] hover:bg-[#DFE0DB] cursor-pointer" onClick={() => handleAccessClass(c)}>
                <div>{c.schoolYear}</div>
                <div>{c.id}</div>
                <div>{formattedEnums.shiftFormat[c.shift]}</div>
