    ...
    <div className="bg-white flex flex-col gap-4">
      <div className="flex justify-center border border-[#e1dcdc]">
        <div className="bg-white p-4 rounded-full w-24 h-24 flex mt-2 mb-2 items-center justify-center border border-[#e1dcdc]">
          <CircleBadge children={classrooms.length} size={96} bgColor="bg-[#1839E1]" textColor="text-white"/>
        </div>
      </div>
      ...
      <div className="flex gap-20">
        <div className="flex flex-col p-4 items-center gap-2">
          ...
          <select id="year" name="year" className="rounded-sm border border-[#e1dcdc] p-2">
        ...
        <div className="flex flex-col items-center justify-center gap-2">
          ...
          <select id="turn" name="turn" className="rounded-sm border border-[#e1dcdc] p-2">
            <option value="">Selecione</option>
        ...
        <div className="flex flex-col items-center justify-center gap-2">
          ...
          <select id="stage" name="stage" className="rounded-sm border border-[#e1dcdc] p-2">
            <option value="">Selecione</option>
      ...
      <div className="flex">
        <input type="text" placeholder="Busque por turmas..." className="font-normal border-[#e1dcdc] w-[50%] h-10 border rounded-md placeholder:text-[#999999] px-4 placeholder:text-[13px] md:text-[16px] xl:placeholder:text-lg"/>
        <BtnGeneric color="search" size="md" className="ml-4" children={"Buscar"}/>
      </div>
          ...
          {classrooms.map((c) => (
            <div key={c.id} className="p-2 flex justify-between border border-[#e1dcdc] hover:bg-[#DFE0DB] cursor-pointer">
              ...
              <div className="flex gap-2 items-center">
                <Icon icon="mingcute:zoom-in-fill" className="text-blue-500"/>
